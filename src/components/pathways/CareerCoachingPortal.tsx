...
function RecommendedView({ data, onSelectPath, savedPaths, toggleSave }: any) {
  const lanes = [
    ...
    { path: data.categories[1].paths[0], label: "New Horizon", color: "#F59E0B", icon: <Compass size={16} color="#fff" /> },
    { path: data.categories[2].paths[0], label: "Potential", color: "#10B981", icon: <Zap size={16} fill="#fff" /> },
    { path: data.categories[3].paths[0], label: "High Match", color: "#8B5CF6", icon: <TrendingUp size={16} color="#fff" /> }
  ];
